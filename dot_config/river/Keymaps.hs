module Keymaps where
  ...
  setMouse = do {
      ...
      ;spawnCommand "riverctl map normal Super L send-layout-cmd wideriver '--ratio +0.025'"
      ;spawnCommand "riverctl map normal Super H send-layout-cmd wideriver '--ratio -0.025'"
      ;return ()}
